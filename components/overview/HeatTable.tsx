...
function getPointCategoryName(point: { [x: string]: string | number; series: any }, dimension: string) {
...
export default function HeatTable({ data, title }: CommonChartComponentProps<CourseClassTimeStatistic>) {
   ...
   useEffect(() => {
      ...
      const rowData = data.map((item) => {
         ...
         courses.map((weekday) => {
            const index = weekDays.findIndex((item: string) => item === weekday);
