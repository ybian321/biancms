...
export const MessageProvider = ({ children }) => {
   ...
   return <MessageStatisticsContext.Provider value={{ msgStore: state, dispatch }}>{children}</MessageStatisticsContext.Provider>;
};

export const useMsgStatistic = () => useContext<{ msgStore: StoreState; dispatch: Dispatch<MessageAction> }>(MessageStatisticsContext);
